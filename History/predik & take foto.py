                ...
                if results.detections:
                    for detection in results.detections:
                        ...
                        if name != "Gk Kenal":
                            ...
                            if name not in recognized_since:
                            ...
                            elif now - recognized_since[name] >= 2.0:  # sudah dikenali selama >= 2 detik
                                if detect_blink(frame, name) and recent_blink(name):
                                    ...
                                    recognized_since.pop(name, None)  # Reset agar tidak berulang
                        else:
                            recognized_since.pop(name, None)  # Reset jika tidak dikenali lagi
